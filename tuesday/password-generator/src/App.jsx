...
<h1 className='text-lg text-center text-white my-3'>Password generator</h1>
 ...
 className='outline-none bg-blue-700 text-white px-3 py-0.5 transition duration-300 ease-in-out hover:bg-blue-800'>copy</button>
</div>
<div className='flex text-sm gap-x-2 bg'> 
